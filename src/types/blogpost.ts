export interface CoverImage {
   ...
   */
  mimeType: string;
  /** No idea. Feel free to make a pull request or send me a dm <3 */
  attached: boolean;
...
export type Blog = {
   ...
   * @note As of making this documentation, Hytale hasnt used this feature once.
   */
  tags: string[];
  /** The unique ID of the blogpost */
  _id: string;
  /** The author of who posted the blogpost */
  author: string;
